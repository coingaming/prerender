    ...
    return new Promise((resolve, reject) => {
        ...
        Promise.all([
            ...
            Network.loadingFailed((params) => {
                ...
                if (tab.prerender.requests[params.requestId]) {
                    tab.prerender.numRequestsInFlight--;
                    if (params.blockedReason !== 'inspector' && (tab.prerender.logRequests || this.options.logRequests)) util.log('-', tab.prerender.numRequestsInFlight, tab.prerender.requests[params.requestId], params.errorText);
                    delete tab.prerender.requests[params.requestId];
                }
            });
